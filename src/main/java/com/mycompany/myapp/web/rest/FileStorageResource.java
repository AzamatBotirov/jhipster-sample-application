...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.FileStorage}.
 */
@RestController
@RequestMapping("/api")
public class FileStorageResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/file-storages/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<FileStorage> partialUpdateFileStorage(
        ...
        Optional<FileStorage> result = fileStorageService.partialUpdate(fileStorage);
