      ...
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterSampleApplicationApp.job.jobTitle')" for="job-jobTitle">Job Title</label>
            <input
              type="text"
              class="form-control"
              name="jobTitle"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterSampleApplicationApp.job.minSalary')" for="job-minSalary"
              >Min Salary</label
            >
            <input
              type="number"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterSampleApplicationApp.job.maxSalary')" for="job-maxSalary"
              >Max Salary</label
            >
            <input
              type="number"
          ...
          <div class="form-group">
            <label v-text="$t('jhipsterSampleApplicationApp.job.task')" for="job-task">Task</label>
            <select
              class="form-control"
              id="job-task"
              data-cy="task"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterSampleApplicationApp.job.employee')" for="job-employee">Employee</label>
