      ...
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterSampleApplicationApp.jobHistory.startDate')" for="job-history-startDate"
              >Start Date</label
            >
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterSampleApplicationApp.jobHistory.endDate')" for="job-history-endDate"
              >End Date</label
            >
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterSampleApplicationApp.jobHistory.language')" for="job-history-language"
              >Language</label
            >
            <select
              class="form-control"
              ...
              data-cy="language"
            >
              <option value="FRENCH" v-bind:label="$t('jhipsterSampleApplicationApp.Language.FRENCH')">FRENCH</option>
              <option value="ENGLISH" v-bind:label="$t('jhipsterSampleApplicationApp.Language.ENGLISH')">ENGLISH</option>
              <option value="SPANISH" v-bind:label="$t('jhipsterSampleApplicationApp.Language.SPANISH')">SPANISH</option>
            </select>
          </div>
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterSampleApplicationApp.jobHistory.job')" for="job-history-job">Job</label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterSampleApplicationApp.jobHistory.department')" for="job-history-department"
              >Department</label
            >
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterSampleApplicationApp.jobHistory.employee')" for="job-history-employee"
              >Employee</label
            >
