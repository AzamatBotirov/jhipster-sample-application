...
class FileStorageResourceIT {
    ...
    void createFileStorage() throws Exception {
        ...
        assertThat(testFileStorage.getName()).isEqualTo(DEFAULT_NAME);
        assertThat(testFileStorage.getCountryName()).isEqualTo(DEFAULT_COUNTRY_NAME);
    ...
    void putNewFileStorage() throws Exception {
        ...
        FileStorage testFileStorage = fileStorageList.get(fileStorageList.size() - 1);
        assertThat(testFileStorage.getName()).isEqualTo(UPDATED_NAME);
        assertThat(testFileStorage.getCountryName()).isEqualTo(UPDATED_COUNTRY_NAME);
    ...
    void partialUpdateFileStorageWithPatch() throws Exception {
        ...
        partialUpdatedFileStorage.extension(UPDATED_EXTENSION).hashId(UPDATED_HASH_ID).uploadPath(UPDATED_UPLOAD_PATH);
